 ...
 * 
 */
@WebServiceClient(name = "CountryInfoService", targetNamespace = "http://www.oorsprong.org/websamples.countryinfo", wsdlLocation = "file:/C:/Users/mrinmoy.das/eclipse-workspace/Country/src/CountryInfoService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Users/mrinmoy.das/eclipse-workspace/Country/src/CountryInfoService.wsdl");
