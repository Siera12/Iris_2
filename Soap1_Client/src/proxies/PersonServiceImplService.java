 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://soap.com/", wsdlLocation = "file:/C:/Users/mrinmoy.das/eclipse-workspace/Soap1_Client/myperson.wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://soap.com/", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/mrinmoy.das/eclipse-workspace/Soap1_Client/myperson.wsdl");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://soap.com/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.com/", "PersonServiceImplPort"), PersonService.class, features);
    }
